        ...
        champ: function(options) {
            ...
            return this.each(function() {
                ...
                if (controllers == "true") {
                    ...
                    parent.append("<div class='controller'><span class='previous'><i class='fa fa-angle-left' aria-hidden='true' style='font-size: 25px;line-height: 19px;'></i></span><span class='next'><i class='fa fa-angle-right' aria-hidden='true' style='font-size: 25px;line-height: 19px;'></i></span></div>");
                }
